...
**Local Generals.io（LocalGen）** 是一个强调 **本地优先** 的开源策略项目。

上游 README 反复强调的场景主要有三类：

- **完全离线** 地体验 generals.io 风格玩法
- 使用 **开箱即用的内置 Bot** 直接开始对局
- 和同一局域网中的朋友进行 **本地联机对战**

README 也明确欢迎通过 GitHub issue 和 pull request 提交想法、Bug 报告与改进建议。
...
> 上游 README 也特别提醒：你现在看到的 `master` 分支仍在开发中。如果你只想下载旧版稳定构建，请优先前往 Releases 页面，而不要把最新分支默认当作最终用户发行版。
